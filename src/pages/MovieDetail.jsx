...
import Backup from "../assets/no_image.jpg"
...
// displayBackgroundImage("/bckxSN9ueOgm0gJpVJmPQrecWul.jpg")
// document.documentElement.classList.add("bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply");
}, [])
  ...
  return (
    <main  >
      <section id="movie-details" className=" flex justify-around flex-wrap py-5">
